...
// Program Description: This program allows the user to upload and apply on it diffrent 15 filters and the user can choose more than one image to apply the filter needed, 
// the user can apply diffrent filters on the same image, it allows the user to save the image too.
